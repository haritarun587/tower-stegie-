...
function setup() {
  ...
  box1 = new BlueBox(500,300,20,30);
  box2 = new YellowBox(520,360,20,30);
  box3 = new GreenBox(546,360,20,30);
  ...
  box15 = new GreenBox(580,330,20,30);

  box16 = new YellowBox(530,28,20,30);
  ...
  box26 = new GreenBox(550,135,20,30);
...
function mouseDragged(){
  Matter.Body.setPosition(ball.body,{x:mouseyX,y:mouseyY});
}
